if (!localStorage.getItem("token")) {
  ...
  function createMessage(side, text, hasProfilePic) {
    ...
    if (text.startsWith("http://localhost:3000/api/photo")) {
      ...
      imageElement.style.maxWidth = "100%"; // Ajuster la largeur de l'image
      imageElement.style.maxHeight = "200px"; // Ajuster la hauteur de l'image
      imageElement.style.borderRadius = "13px";
